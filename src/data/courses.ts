...
export const COURSES_DATA: Course[] = [
  // 1 — Formation Automatisme Industriel & Automates Programmables
  {
    ...
    seoFileName: 'industrial-automation.jpg',
    objectives: [
  ...
  // 3 — Supervision Industrielle SCADA (WinCC / InTouch / PC Vue)
  {
    ...
    image: '/images/scada-training.jpg',
    ...
    seoFileName: 'scada-training.jpg',
    objectives: [
  ...
  // 4 — Réseaux de Communication Industriels (PROFINET, Ethernet/IP, Modbus TCP...)
  {
    ...
    image: '/images/industrial-networks.jpg',
    ...
    seoFileName: 'industrial-networks.jpg',
    objectives: [
  ...
  // 5 — Diagnostic des Systèmes Automatisés en Production
  {
    ...
    image: '/images/automated-system-diagnostics.jpg',
    ...
    seoFileName: 'automated-system-diagnostics.jpg',
    objectives: [
  ...
  // 6 — Formation Variateurs de Vitesse Industriels
  {
    ...
    image: '/images/variable-speed-drives.jpg',
    ...
    seoFileName: 'variable-speed-drives.jpg',
    objectives: [
  ...
  // 7 — Systèmes Photovoltaïques
  {
    ...
    image: '/images/photovoltaic-systems.jpg',
    ...
    seoFileName: 'photovoltaic-systems.jpg',
    objectives: [
  ...
  // 8 — Électricité Industrielle
  {
    ...
    image: '/images/industrial-electricity.jpg',
    ...
    seoFileName: 'industrial-electricity.jpg',
    objectives: [
  ...
  // 9 — Efficacité Énergétique et ISO 50001
  {
    ...
    image: '/images/energy-efficiency-iso50001.jpg',
    ...
    seoFileName: 'energy-efficiency-iso50001.jpg',
    objectives: [
  ...
  // 10 — Maintenance Industrielle
  {
    ...
    image: '/images/industrial-maintenance.jpg',
    ...
    seoFileName: 'industrial-maintenance.jpg',
    objectives: [
  ...
  // 11 — Diagnostic et Contrôle des Cartes Électroniques Industrielles
  {
    ...
    image: '/images/industrial-electronics.jpg',
    ...
    seoFileName: 'industrial-electronics.jpg',
    objectives: [
  ...
  // 12 — Habilitation Électrique
  {
    ...
    seoFileName: 'electrical-safety.jpg',
    objectives: [
