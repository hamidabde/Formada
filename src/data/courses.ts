...
export const COURSES_DATA: Course[] = [
  // 1 — Formation Automatisme Industriel & Automates Programmables
  {
    ...
    shortDescription: 'Formation pratique en automatisme industriel au Maroc : automates PLC/API, Grafcet, programmation, capteurs, actionneurs et diagnostic.',
    image: 'https://i.postimg.cc/9McsRV5D/Formation-Automatisme-Industriel-Automates-Programmables-(API-PLC).webp',
    imageAlt: 'Formation Automatisme Industriel & Automates Programmables (API / PLC) au Maroc',
    objectives: [
  ...
  // 2 — Programmation des Interfaces Homme-Machine (IHM / HMI)
  {
    ...
    shortDescription: 'Formation IHM/HMI au Maroc : conception et programmation d’interfaces opérateur pour piloter, visualiser et diagnostiquer les automatismes.',
    image: 'https://i.postimg.cc/bJLW1MpH/Programmation-des-Interfaces-Homme-Machine-(IHM.webp',
    imageAlt: 'Formation IHM HMI et écrans opérateurs industriels au Maroc',
    objectives: [
  ...
  // 3 — Supervision Industrielle SCADA (WinCC / InTouch / PC Vue)
  {
    ...
    shortDescription: 'Formation SCADA au Maroc sur WinCC, InTouch et PC Vue : supervision, alarmes, tendances, acquisition de données et pilotage industriel.',
    image: 'https://i.postimg.cc/pTk4K7RG/Supervision-Industrielle-SCADA.webp',
    imageAlt: 'Formation Supervision Industrielle SCADA (WinCC, InTouch, PC Vue) au Maroc',
    objectives: [
  ...
  // 4 — Réseaux de Communication Industriels (PROFINET, Ethernet/IP, Modbus TCP...)
  {
    ...
    shortDescription: 'Formation aux réseaux industriels au Maroc : PROFINET, Ethernet/IP, Modbus TCP, configuration, communication et diagnostic des équipements.',
    image: 'https://i.postimg.cc/vBXk5jb0/Reseaux-de-Communication-Industriels-(PROFINET-Ethernet.webp',
    imageAlt: 'Formation Réseaux Industriels PROFINET et Modbus TCP au Maroc',
    objectives: [
  ...
  // 5 — Diagnostic des Systèmes Automatisés en Production
  {
    ...
    shortDescription: 'Formation pratique au diagnostic des systèmes automatisés au Maroc : recherche de pannes, analyse PLC, capteurs, actionneurs et réduction des arrêts.',
    image: 'https://i.postimg.cc/ZRJXBZtR/Diagnostic-des-Systemes-Automatises-en-Production.webp',
    imageAlt: 'Formation Diagnostic des Systèmes Automatisés en Production au Maroc',
    objectives: [
  ...
  // 6 — Formation Variateurs de Vitesse Industriels
  {
    ...
    shortDescription: 'Formation variateurs de vitesse au Maroc : fonctionnement, paramétrage, mise en service, diagnostic, dépannage et maintenance des VFD.',
    image: 'https://i.postimg.cc/j5RBwK0H/Formation-Variateurs-de-Vitesse-Industriels-Parametrage-Depannage-Maintenance.webp',
    imageAlt: 'Formation Variateurs de Vitesse Industriels et Paramétrage VFD au Maroc',
    objectives: [
  ...
  // 7 — Systèmes Photovoltaïques
  {
    ...
    shortDescription: 'Formation photovoltaïque au Maroc : étude, dimensionnement, installation, câblage, mise en service et maintenance des systèmes solaires PV.',
    image: 'https://i.postimg.cc/MTzgMx2G/Etude-Dimensionnement-et-Installation-des-Systemes-Photovoltaiques.webp',
    imageAlt: 'Formation Photovoltaïque et Installation Systèmes Solaires PV au Maroc',
    objectives: [
  ...
  // 8 — Électricité Industrielle
  {
    ...
    shortDescription: 'Formation en électricité industrielle au Maroc : installations BT, protections, moteurs, schémas électriques, câblage et diagnostic.',
    image: 'https://i.postimg.cc/mDTKzRfc/Formation-Electricite-Industrielle-Installations-Electriques-BT.webp',
    imageAlt: 'Formation Électricité Industrielle et Installations Électriques BT au Maroc',
    objectives: [
  ...
  // 9 — Efficacité Énergétique et ISO 50001
  {
    ...
    shortDescription: 'Formation ISO 50001 au Maroc : management de l’énergie, performance énergétique, usages significatifs, indicateurs EnPI et optimisation industrielle.',
    image: 'https://i.postimg.cc/FRhwdm5H/Efficacite-Energetique-dans-l-Industrie-ISO-50001.webp',
    imageAlt: 'Formation Efficacité Énergétique dans l’Industrie et ISO 50001 au Maroc',
    objectives: [
  ...
  // 10 — Maintenance Industrielle
  {
    ...
    shortDescription: 'Formation pratique en maintenance industrielle au Maroc : maintenance préventive, corrective, diagnostic et dépannage des équipements.',
    image: 'https://i.postimg.cc/G2b68rwy/Formation-en-Maintenance-Industrielle.webp',
    imageAlt: 'Formation en Maintenance Industrielle Préventive et Corrective au Maroc',
    objectives: [
  ...
  // 11 — Diagnostic et Contrôle des Cartes Électroniques Industrielles
  {
    ...
    shortDescription: 'Formation au diagnostic des cartes électroniques industrielles au Maroc : mesures, composants, oscilloscope, identification des défauts et contrôle.',
    image: 'https://i.postimg.cc/tT98ZyQC/Diagnostic-et-Controle-des-Cartes-Electroniques-Industrielles.webp',
    imageAlt: 'Formation Diagnostic et Contrôle des Cartes Électroniques Industrielles au Maroc',
    objectives: [
  ...
  // 12 — Habilitation Électrique
  {
    ...
    shortDescription: 'Formation en habilitation et sécurité électrique au Maroc : risques électriques, prévention, consignation et interventions en sécurité.',
    image: 'https://i.postimg.cc/85TxJDQf/Formation-en-Habilitation-Electrique.webp',
    imageAlt: 'Formation en Habilitation et Sécurité Électrique au Maroc',
    objectives: [
  ...
  // 13 — Formation en QHSE
  {
    ...
    category: 'qhse',
    categoryLabel: 'QHSE',
    shortDescription: 'Formation QHSE au Maroc : qualité, hygiène, sécurité au travail, prévention des risques professionnels et management environnemental.',
    image: 'https://i.postimg.cc/bJq4D8cQ/Formation-en-QHSE-Qualite-Hygiene-Securite-Environnement.webp',
    imageAlt: 'Formation QHSE Qualité Hygiène Sécurité et Environnement au Maroc',
    objectives: [
