...
export const COURSES_DATA: Course[] = [
  // 1 — Formation Automatisme Industriel & Automates Programmables
  {
    ...
    image: '/images/industrial-automation.webp',
    imageWebp: '/images/industrial-automation.webp',
    ...
    imageCaption: "Banc de travaux pratiques avec automates programmables PLC Siemens S7-1500 & Schneider, raccordements E/S réels et logiciel TIA Portal.",
  ...
  // 2 — Programmation des Interfaces Homme-Machine (IHM / HMI)
  {
    ...
    image: '/images/hmi-training.webp',
    imageWebp: '/images/hmi-training.webp',
    ...
    imageCaption: "Pupitre tactile IHM industriel avec synoptiques de contrôle dynamique, boutons de commande et gestion d'alarmes temps réel.",
  ...
  // 3 — Supervision Industrielle SCADA (WinCC / InTouch / PC Vue)
  {
    ...
    image: '/images/scada-training.webp',
    imageWebp: '/images/scada-training.webp',
    ...
    imageCaption: "Poste de supervision SCADA multi-écrans avec synoptiques d'usine animés, télégestion, historiques et base de données industrielles.",
  ...
  // 4 — Réseaux de Communication Industriels (PROFINET, Ethernet/IP, Modbus TCP...)
  {
    ...
    image: '/images/industrial-networks.webp',
    imageWebp: '/images/industrial-networks.webp',
    ...
    imageCaption: "Architecture réseau de terrain PROFINET, Modbus TCP et commutateurs administrables pour communication inter-automates et périphérie.",
  ...
  // 5 — Diagnostic des Systèmes Automatisés en Production
  {
    ...
    image: '/images/automated-system-diagnostics.webp',
    imageWebp: '/images/automated-system-diagnostics.webp',
    ...
    imageCaption: "Méthodologie de diagnostic et recherche de panne avec console de programmation, oscilloscope et analyse pas-à-pas des cycles séquentiels.",
  ...
  // 6 — Formation Variateurs de Vitesse Industriels
  {
    ...
    image: '/images/variable-speed-drives.webp',
    imageWebp: '/images/variable-speed-drives.webp',
    ...
    imageCaption: "Banc d'essai de variateurs de fréquence Siemens Sinamics & Schneider Altivar avec moteurs asynchrones et régulation de vitesse PID.",
  ...
  // 7 — Systèmes Photovoltaïques
  {
    ...
    image: '/images/photovoltaic-systems.webp',
    imageWebp: '/images/photovoltaic-systems.webp',
    ...
    imageCaption: "Installation solaire photovoltaïque industrielle avec onduleurs triphasés, régulateurs MPPT et coffrets de protection DC/AC.",
  ...
  // 8 — Électricité Industrielle
  {
    ...
    image: '/images/industrial-electricity.webp',
    imageWebp: '/images/industrial-electricity.webp',
    ...
    imageCaption: "Armoire de distribution électrique industrielle basse tension avec disjoncteurs moteurs, contacteurs et schéma conforme NF C 15-100.",
  ...
  // 9 — Efficacité Énergétique et ISO 50001
  {
    ...
    image: '/images/energy-efficiency-iso50001.webp',
    imageWebp: '/images/energy-efficiency-iso50001.webp',
    ...
    imageCaption: "Centrale de mesure et d'analyse d'énergie électrique avec analyseurs de réseau pour l'audit et l'optimisation énergétique ISO 50001.",
  ...
  // 10 — Maintenance Industrielle
  {
    ...
    image: '/images/industrial-maintenance.webp',
    imageWebp: '/images/industrial-maintenance.webp',
    ...
    imageCaption: "Atelier de maintenance électromécanique avec alignement laser d'arbres, analyse vibratoire, équilibrage et GMAO usine.",
  ...
  // 11 — Diagnostic et Contrôle des Cartes Électroniques Industrielles
  {
    ...
    image: '/images/industrial-electronics.webp',
    imageWebp: '/images/industrial-electronics.webp',
    ...
    imageCaption: "Laboratoire de réparation électronique au composant avec station de soudage CMS, oscilloscope numérique et banc de test d'alimentations.",
  ...
  // 12 — Habilitation Électrique
  {
    ...
    imageWebp: '/images/electrical-safety.webp',
    ...
    imageCaption: "Équipements de protection individuelle (EPI) isolants et vérificateur d'absence de tension (VAT) pour habilitation NF C 18-510.",
  ...
  // 13 — Formation en QHSE
  {
    ...
    image: '/images/qhse.webp',
    imageWebp: '/images/qhse.webp',
    ...
    imageCaption: "Mise en situation pratique de sécurité en milieu industriel, consignation de vannes/énergie LOTO et prévention des risques professionnels.",
